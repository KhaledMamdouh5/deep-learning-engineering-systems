...
history = model_tf.fit(x_train, y_train, epochs=100, batch_size=32 , validation_data=(x_val, y_val), verbose=1)
...
model_sgd = SGDRegressor(loss='squared_error', penalty='l2', alpha=0.0005, max_iter=3000, tol=1e-6, random_state=50)
